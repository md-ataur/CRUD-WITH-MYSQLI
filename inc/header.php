...
<head>
	...
	.tblone{width:100%; text-align:center;border:1px solid #fff;margin:20px 0}
	...
	.btn{color: #000;text-decoration: none;border: 1px solid #000;padding: 3px 7px;background: #fff;}
	</style>
</head>
<body>
